...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignment-7-roadsign.git;protocol=ssh;branch=main \
           file://misc-modules_makefile.patch \
           file://misc-modules \
           file://module_load.sh \
...
FILES:${PN} += "${sysconfdir}/init.d/misc-modules \
                ${sysconfdir}/init.d/module_load.sh \
                ${sysconfdir}/init.d/module_unload.sh \
                "
...
do_install:append () {
    ...
    install -m 0755 ${WORKDIR}/misc-modules ${D}${sysconfdir}/init.d
    install -m 0755 ${WORKDIR}/module_load.sh ${D}${sysconfdir}/init.d
    install -m 0755 ${WORKDIR}/module_unload.sh ${D}${sysconfdir}/init.d
